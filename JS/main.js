...
$("document").ready(function () {
  ...
  contactBtn.click((e) => {
    ...
    nameInput.setAttribute("placeholder", "ex: Mohamed Sobhy");
    ...
    emailInput.setAttribute("placeholder", "ex: mohamedsobhy@gmail.com");
    ...
    ageInput.setAttribute("placeholder", "ex: 25");
    ...
    confirmInput.setAttribute("placeholder", " Repassword");
    ...
    submitBtn.classList.add("btn", "btn-outline-danger", "rounded" , "px-2" , "mt-3");
